...
enum TipoUpgrade { DANO, MOEDA, VIDA, VELOCIDADE_ATAQUE, VELOCIDADE_INIMIGO, CUSTO_CONSTRUCAO, QUANTIDADE_INIMIGOS, ALCANCE, RICOCHETE, INFLAMAVEL, ESPINHO, DANO_CHEFE }
