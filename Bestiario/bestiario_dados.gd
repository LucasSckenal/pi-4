...
const INIMIGOS: Array = [
	...
	{"nome": "Peixe-Lanterna", "mapa": 4, "categoria": "Comum", "icone": "res://Icons/PeixeLanternaPreview.png",
	 "lore": "Predador das profundezas que usa a luzinha da cabeça pra atrair incautos. Onde a isca brilha, os dentes não estão longe.",
	 "comportamento": "Flutua acima da água e, de tempos em tempos, brilha a isca pra atrair o fogo das torres — escudando a horda.",
	 "fraqueza": "Defesas antiaéreas e foco rápido enquanto a isca está apagada.",
	 "avistamento": "Abismo da fenda"},
